...
$shizenPacks = [
    [
        'id' => 'kitsune',
        'name' => 'Kitsune',
        'descriptor' => 'Fox spirit ember, twilight indigo, sacred gold',
        'colors' => ['#C9521A', '#2D2B55', '#F5ECD7', '#D4A827', '#1A2C1E'],
        'active' => true,
    ],
    [
        'id' => 'wabi-sabi',
        'name' => 'Wabi-Sabi Neutral',
        'descriptor' => 'Weathered quiet, muromachi tea room',
        'colors' => ['#F5F0E8', '#2C2C2C', '#8B7355', '#6B6B6B', '#D4CFC4'],
        'active' => false,
    ],
    [
        'id' => 'shinto',
        'name' => 'Shinto Ceremonial',
        'descriptor' => 'Torii vermillion, shrine white, sacred gold',
        'colors' => ['#FFFEF9', '#C41E3A', '#C9A227', '#1a1a1a', '#E8E0D5'],
        'active' => false,
    ],
    [
        'id' => 'sakura',
        'name' => 'Sakura Season',
        'descriptor' => 'Blossom pink, new leaf, pale sky',
        'colors' => ['#FFF5F7', '#E8B4BC', '#7A9B76', '#D4E4ED', '#2D2A2A'],
        'active' => false,
    ],
    [
        'id' => 'yoru',
        'name' => 'Yoru (Night)',
        'descriptor' => 'Deep indigo, paper white, lantern warmth',
        'colors' => ['#1E2A3A', '#F5F0E8', '#7B9BB0', '#C4A574', '#3A4A5A'],
        'active' => false,
    ],
];
...
<body>
  ...
  <section class="hero" aria-labelledby="hero-heading">
    ...
    <div class="hero-inner">
      <div>
        ...
        <p class="hero-lead">Build atmospheric, Japan-inspired websites with Shizen's Kitsune theme pack — complete CSS variables, utility classes, and a free Kitsune Theme Maker.</p>
        <div class="hero-cta">
          <a href="#theme-maker" class="btn btn-primary">Try the Theme Maker ↓</a>
          <a href="spec.php" class="btn btn-secondary">View Shizen Docs →</a>
        </div>
      </div>
  ...
  <main id="main">
    ...
    <section class="section section-alt" aria-labelledby="shizen-heading">
      <h2 id="shizen-heading">Kitsune Is Part of Shizen</h2>
      <p style="max-width:42rem;color:rgba(245,236,215,0.88);">The Kitsune aesthetic pack extends the <a href="spec.php">Shizen Design System</a> on CSSKitsune — Japanese design tokens, cultural vocabulary, and AI-ready prompts. Use this page's theme maker for quick prototypes, then pair tokens with the <a href="prompt-builder.php">Prompt Builder</a> for full-stack kitsune web projects.</p>

      <div class="pack-scroll" role="list" aria-label="Shizen aesthetic packs">
        <?php foreach ($shizenPacks as $pack): ?>
        <article class="pack-card<?php echo $pack['active'] ? ' active' : ''; ?>" role="listitem">
          <h3><?php echo htmlspecialchars($pack['name']); ?><?php if ($pack['active']): ?> <span style="color:var(--kitsune-ember);font-size:0.75rem;">· active</span><?php endif; ?></h3>
          <div class="pack-dots" aria-hidden="true">
            <?php foreach ($pack['colors'] as $c): ?>
            <span style="background:<?php echo htmlspecialchars($c); ?>"></span>
            <?php endforeach; ?>
          </div>
          <p><?php echo htmlspecialchars($pack['descriptor']); ?></p>
        </article>
        <?php endforeach; ?>
      </div>
      <p class="pack-cta"><a href="index.php" class="btn btn-secondary">Explore All Shizen Packs →</a></p>
    </section>
  ...
  <footer class="page-footer">
    <a href="index.php">CSSKitsune</a> · <a href="site-map.php">Sitemap</a> · Shizen Design System
  </footer>
</body>
</html>
